...
namespace App\Filament\Resources\UpdatedUnitsSales;

use App\Filament\Resources\UpdatedUnitsSales\Pages;
use BackedEnum;
...
class UpdatedUnitsSalesResource extends Resource
{
    protected static ?string $navigationLabel = 'Updated Units (Sales)';
    protected static ?string $modelLabel = 'Updated Unit (Sales)';
    ...
    {
        return [
            'index' => Pages\ListUpdatedUnitsSales::route('/'),
        ];
    }
}

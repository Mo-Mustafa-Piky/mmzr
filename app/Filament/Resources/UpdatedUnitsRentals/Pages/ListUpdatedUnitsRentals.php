...
namespace App\Filament\Resources\UpdatedUnitsRentals\Pages;

use App\Filament\Resources\UpdatedUnitsRentals\UpdatedUnitsRentalsResource;
...
class ListUpdatedUnitsRentals extends Page implements HasTable
{
    use InteractsWithTable;
    
    protected static string $resource = UpdatedUnitsRentalsResource::class;
    protected string $view = 'filament.resources.updated-units-rentals.pages.list-updated-units-rentals';
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('clear_cache')
                ...
                ->action(function () {
                    \Illuminate\Support\Facades\Cache::forget('goyzer_updated_units_rentals');
                    Notification::make()
    ...
    {
        $result = \Illuminate\Support\Facades\Cache::rememberForever('goyzer_updated_units_rentals', function () {
            return app(GoyzerService::class)->getRentalListingsLastUpdated();
        });

...
namespace App\Filament\Resources\UpdatedUnitsRentals;

use App\Filament\Resources\UpdatedUnitsRentals\Pages;
use BackedEnum;
...
class UpdatedUnitsRentalsResource extends Resource
{
    protected static ?string $navigationLabel = 'Updated Units (Rentals)';
    protected static ?string $modelLabel = 'Updated Unit (Rentals)';
    ...
    {
        return [
            'index' => Pages\ListUpdatedUnitsRentals::route('/'),
        ];
    }
}
